...
func (_m *Service) AllDoctor() ([]doctors.Domain, error) {
	ret := _m.Called()
...
func (_m *Service) Delete(id int) (string, error) {
	ret := _m.Called(id)
...
func (_m *Service) DoctorByID(id int) (doctors.Domain, error) {
	ret := _m.Called(id)
...
func (_m *Service) Login(username string, password string) (doctors.Domain, error) {
...
func (_m *Service) Register(domain *doctors.Domain) (doctors.Domain, error) {
...
func (_m *Service) Update(docID int, domain *doctors.Domain) (doctors.Domain, error) {
